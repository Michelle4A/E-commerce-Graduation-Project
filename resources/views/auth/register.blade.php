    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            <div class="card" style="border-radius: 10px; background: #e2cce6; ">
                ...
                <div style="text-align: center; border-radius: 10px; width: 150px; height: 50px; margin: 0 auto; padding-top: 10px;">
                    {{ __('Crear cuenta de CocoaSweet') }}
                </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-5">
                                <button type="submit" class="btn btn-primary" style="background-color: #FB9CE6 ;">
                                    {{ __('Registrarse') }}
                                </button>
                            </div>
                        </div>
